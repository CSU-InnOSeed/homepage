...
export const APPLY_CATEGORIES: ApplyCategory[] = [
  ...
  { key: 'tech', title: '技术特长', describe: '按熟练度从高到低多选',
    options: [
      ...
      { name: '具身智能', glyph: '⚙' }, { name: '计算机视觉', glyph: '◉' }, { name: '数据优化', glyph: '◇' },
      { name: '逆向', glyph: '⇄' }, { name: '科研', glyph: '✎' }, { name: '创业', glyph: '✦' },
      { name: 'System', glyph: '⌥' }, { name: '项目', glyph: '⬡' }, { name: '交互设计', glyph: '◈' },
      { name: '流量管理', glyph: '⇆' }, { name: 'Web3D', glyph: '◬' }, { name: '医学图像', glyph: '✚' },
      { name: '测试', glyph: '◧' }, { name: '密码学', glyph: '⚿' }, { name: '可视化', glyph: '◫' },
      { name: '嵌入式', glyph: '⊞' }, { name: '数据库', glyph: '⊟' },
    ]},
  { key: 'play', title: '兴趣爱好', describe: '挑点能一起玩的',
    options: [
      ...
      { name: '干饭', glyph: '☖' }, { name: '羽毛球', glyph: '⬭' }, { name: '排球', glyph: '🏐' },
      { name: '足球', glyph: '⚽' }, { name: '篮球', glyph: '🏀' }, { name: '游泳', glyph: '≈' },
      { name: '唱歌', glyph: '♪' }, { name: '美术', glyph: '✎' }, { name: '舞蹈', glyph: '✧' },
      { name: '桌游', glyph: '⬡' }, { name: 'MC', glyph: '⛏' }, { name: '睡觉', glyph: '☾' },
      { name: '撸猫', glyph: '🐱' }, { name: '撸狗', glyph: '🐶' }, { name: '轻小说', glyph: '✎' },
      { name: '乒乓球', glyph: '🏓' }, { name: '麻将', glyph: '⬢' }, { name: '象棋', glyph: '♟' },
      { name: '西洋棋', glyph: '♛' }, { name: '魔术', glyph: '✦' }, { name: '摄影', glyph: '◉' },
      { name: '电影', glyph: '🎬' }, { name: '创赛', glyph: '🏆' }, { name: '竞赛', glyph: '🥇' },
      { name: '社团', glyph: '👥' },
    ]},
...
export const INTERVIEWERS: Interviewer[] = [
  { code: '~', avatar: '',
    intros: ['INFP。掌握 C++ / Java，擅长网站搭建，偏好前端开发',
      '闲暇喜欢绘画、读小说、看动漫，也会参与创赛；心思细腻，乐于交流，欢迎新成员一起学习探索。'],
    tags: [{ name: '前端' }, { name: '美术' }, { name: '文学' }, { name: '番剧' }, { name: '创赛' }] },
  { code: 'sakura', avatar: '',
    intros: ['我可以和你聊聊后端、AI、生活和对未来的思考', '我的 MBTI 为 : INTP'],
    tags: [{ name: '后端' }, { name: '智能体' }, { name: '大模型' }] },
  { code: 'Flipper', avatar: '',
    intros: ['vibe coding、足球、象棋、就业向',
      '如果你也对 AI 的发展感兴趣，欢迎和我聊聊。我的 MBTI 为 : ENFP'],
    tags: [{ name: '前端' }, { name: '后端' }, { name: '智能体' }, { name: '大模型' },
      { name: '足球' }, { name: '象棋' }, { name: '就业' }] },
  { code: 'MciG', avatar: '',
    intros: ['二次元、排球、开源、具身智能、科研、Infra', '我的 MBTI 为 : 无'],
    tags: [{ name: '番剧' }, { name: '排球' }, { name: '开源' }, { name: '具身智能' },
      { name: '科研' }, { name: 'System' }] },
  { code: 'Shade', avatar: '',
    intros: ['兴趣使然的开发者，感兴趣于交通、模拟经营类游戏，做过 CV 大方向的科研',
      '我的 MBTI 为 : 无'],
    tags: [{ name: '计算机视觉' }, { name: '科研' }, { name: '桌游' }] },
  { code: 'Mr.Li', avatar: '',
    intros: ['深度学习、算法、保研、科研与 MC', '我的 MBTI 为 : ENTJ'],
    tags: [{ name: '深度学习' }, { name: '算法' }, { name: '保研' }, { name: '科研' }, { name: 'MC' }] },
  { code: 'Zenia', avatar: '',
    intros: ['我可以和你聊聊竞赛、项目、电影', '我的 MBTI 为 : INTP'],
    tags: [{ name: '竞赛' }, { name: '项目' }, { name: '电影' }] },
  { code: 'Rowling', avatar: '',
    intros: ['我可以和你聊聊竞赛、科研、社团、企业对接项目与麻将', '我的 MBTI 为 : ESTJ'],
    tags: [{ name: '竞赛' }, { name: '科研' }, { name: '社团' }, { name: '项目' }, { name: '麻将' }] },
